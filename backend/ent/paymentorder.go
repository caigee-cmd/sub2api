...
type PaymentOrder struct {
	...
	// ProrationCredit holds the value of the "proration_credit" field.
	ProrationCredit float64 `json:"proration_credit,omitempty"`
...
func (*PaymentOrder) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case paymentorder.FieldAmount, paymentorder.FieldPayAmount, paymentorder.FieldFeeRate, paymentorder.FieldProrationCredit, paymentorder.FieldRefundAmount:
			values[i] = new(sql.NullFloat64)
		case paymentorder.FieldID, paymentorder.FieldUserID, paymentorder.FieldPlanID, paymentorder.FieldSubscriptionGroupID, paymentorder.FieldSubscriptionDays, paymentorder.FieldUpgradeFromSubscriptionID:
...
func (_m *PaymentOrder) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case paymentorder.FieldProrationCredit:
			if value, ok := values[i].(*sql.NullFloat64); !ok {
				return fmt.Errorf("unexpected type %T for field proration_credit", values[i])
			} else if value.Valid {
				_m.ProrationCredit = value.Float64
			}
...
func (_m *PaymentOrder) String() string {
	...
	builder.WriteString(", ")
	builder.WriteString("proration_credit=")
	builder.WriteString(fmt.Sprintf("%v", _m.ProrationCredit))
	builder.WriteString(", ")
