...
var (
	...
	ChannelMonitorHistoriesColumns = []*schema.Column{
		...
		{Name: "first_token_latency_ms", Type: field.TypeInt, Nullable: true},
	...
	PaymentOrdersColumns = []*schema.Column{
		...
		{Name: "proration_credit", Type: field.TypeFloat64, Default: 0, SchemaType: map[string]string{"postgres": "decimal(20,2)"}},
	...
	UserSubscriptionsColumns = []*schema.Column{
		...
		{Name: "notes", Type: field.TypeString, Nullable: true, SchemaType: map[string]string{"postgres": "text"}},
		{Name: "auto_balance_enabled", Type: field.TypeBool, Default: true},
		{Name: "group_id", Type: field.TypeInt64},
		{Name: "user_id", Type: field.TypeInt64},
	...
	UserSubscriptionsTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			...
			},
			{
				...
				Unique:  false,
				Columns: []*schema.Column{UserSubscriptionsColumns[18], UserSubscriptionsColumns[7], UserSubscriptionsColumns[6]},
			},
			{
