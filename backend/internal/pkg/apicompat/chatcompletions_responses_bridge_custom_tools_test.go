...
func TestResponsesChatBridge_MixedCustomAndNamespaceToolNames(t *testing.T) {
	...
	out := ChatCompletionsResponseToResponses(resp, req.Model, customTools, FunctionToolNames(req.Tools), false, namespaceTools, false)
...
func TestChatCompletionsResponseToResponses_ExplicitFunctionOwnsCustomAliasCollision(t *testing.T) {
	...
	out := ChatCompletionsResponseToResponses(resp, "deepseek-test",
		...
		map[string]NamespacedToolName{"functions__wait": {Namespace: "functions", Name: "wait"}}, false)
...
func TestChatCompletionsResponseToResponses_CustomToolCallOutputItem(t *testing.T) {
	...
	out := ChatCompletionsResponseToResponses(resp, "glm-5.2", map[string]bool{"exec": true}, nil, false, nil, false)
...
func TestChatCompletionsResponseToResponses_ToolSearchCallOutputItem(t *testing.T) {
	...
	out := ChatCompletionsResponseToResponses(resp, "glm-5.2", nil, nil, true, nil, false)
	require.Len(t, out.Output, 1)
...
func TestChatCompletionsResponseToResponses_ToolSearchNotDeclaredKeepsFunctionCall(t *testing.T) {
	...
	out := ChatCompletionsResponseToResponses(resp, "glm-5.2", nil, nil, false, nil, false)
	require.Len(t, out.Output, 1)
	assert.Equal(t, "function_call", out.Output[0].Type)
}
...
func TestChatCompletionsResponseToResponses_NamespacedToolCallRestored(t *testing.T) {
	...
	out := ChatCompletionsResponseToResponses(resp, "glm-5.2", nil, nil, false, nsTools, false)
	require.Len(t, out.Output, 2)
