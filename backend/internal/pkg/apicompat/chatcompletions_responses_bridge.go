...
func ChatCompletionsResponseToResponses(resp *ChatCompletionsResponse, model string, customTools, functionTools map[string]bool, toolSearch bool, namespaceTools map[string]NamespacedToolName, stripReasoning bool) *ResponsesResponse {
	id := ""
	if resp != nil {
		id = resp.ID
	}
	...
	if len(resp.Choices) > 0 {
		...
		out.Output = chatMessageToResponsesOutput(choice.Message, customTools, functionTools, toolSearch, namespaceTools, stripReasoning)
...
func chatMessageToResponsesOutput(message ChatMessage, customTools, functionTools map[string]bool, toolSearch bool, namespaceTools map[string]NamespacedToolName, stripReasoning bool) []ResponsesOutput {
