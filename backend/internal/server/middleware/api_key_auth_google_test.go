...
func (f fakeGoogleSubscriptionRepo) UpdateAutoBalance(ctx context.Context, subscriptionID int64, enabled bool) error {
	return errors.New("not implemented")
}
...
func TestApiKeyAuthWithSubscriptionGoogle_SubscriptionLimitExceededReturns429(t *testing.T) {
	...
	}, nil, nil, &config.Config{RunMode: config.RunModeStandard}, nil)
