export default {
    accounts: {
      ...
      openai: {
        ...
        codexUaContainsPlaceholder: 'User-Agent 包含标记，逗号分隔（如 multica-agent-sdk）',
      ...
      poolModeRetryInterval: '同账号重试间隔（毫秒）',
      poolModeRetryIntervalHint: '仅在池模式下生效。每次同账号重试前的等待时间。0 表示不等待；默认 {default}，最大 {max}。',
